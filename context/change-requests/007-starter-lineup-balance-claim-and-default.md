...
- [ ] Correct the Phase 1 **Fixed Starter Lineup** wording in `context/product/roadmap.md` so it no longer asserts a balance the arithmetic contradicts.
- [ ] Change the default lineup to **6 Law-abiding Citizens and 2 Mafiosos**, leaving the counts configurable.

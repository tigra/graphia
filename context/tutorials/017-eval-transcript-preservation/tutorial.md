...
- Related reading: [tutorial 011](../011-ai-blunder-tracking/tutorial.md) (the ledger this sits beside) and [tutorial 012](../012-eval-ledger-viewer/tutorial.md) (the viewer it extends). The smoke that built this tutorial's war-story section also left two open items in [`context/product/backlog.md`](../../product/backlog.md) — the suite-wide ledger-write guard and a flaky multi-round replay test.

...
- **Configurable game setup** — the size and shape of the table is chosen *before* launching: how many Law-abiding Citizens and how many Mafiosos sit down, the human counted among them. A player who chooses nothing gets six Law-abiding Citizens and two Mafiosos — eight players. Roles are then assigned randomly, the human's included.
...
- User-configurable counts of each role, chosen before launch.

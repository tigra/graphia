...
def _install_sonnet_defaults(fake_sonnet) -> None:
...
async def test_roster_uses_haiku_generated_names(
    ...
    async with app.run_test() as pilot:
        ...
        # Haiku was invoked exactly once (no retry on a valid first response).
...
async def test_retry_on_validation_failure(
    ...
    async with app.run_test() as pilot:
        ...
        # Exactly two Haiku invocations: the failing first + the successful retry.

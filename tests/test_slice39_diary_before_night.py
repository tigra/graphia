...
class _CapturingDiaryFake:
    ...
    def with_structured_output(self, schema: type, **kwargs: object) -> "_CapturingDiaryFake":
        self.bindings += 1
...
class _PerPlayerFailingFake:
    ...
    def with_structured_output(self, schema: type, **kwargs: object) -> "_PerPlayerFailingFake":
        return self

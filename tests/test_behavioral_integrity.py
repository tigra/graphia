...
class _FakeLargeDayAction:
    ...
    def with_structured_output(self, schema: type, **kwargs: object) -> "_FakeLargeDayAction":
        return self
...
class _FakeLargeBallot:
    ...
    def with_structured_output(self, schema: type, **kwargs: object) -> "_FakeLargeBallot":
        return self
...
def test_ai_day_action_retry_block_also_formats_cleanly(
    ...
    class _RejectThenAccept:
        ...
        def with_structured_output(self, schema: type, **kwargs: object) -> "_RejectThenAccept":
            return self
...
def test_ai_day_action_rejects_self_targeted_vote_initiation(
    ...
    class _AlwaysSelfVote:
        ...
        def with_structured_output(self, schema: type, **kwargs: object) -> "_AlwaysSelfVote":
            return self
